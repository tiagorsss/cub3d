...
/*   Updated: 2025/11/05 13:57:33 by treis-ro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			draw_rect(t_cub3d *c, int x, int y, int w, int h, int color);  //!!!!!!!!!!!!!!!!!!!!!!1111
void			draw_line(t_cub3d *c, int x0, int y0, int x1, int y1, int color);  //!!!!!!!!!!!!!!!!!!!!!!!!!!!!11
